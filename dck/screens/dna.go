...
func (s *Scene) dna() {
	...
	intro := s.ring(introText, s.asset("font_intro.png"), 32, 25, 32, s.data.Strings["text_intro"], 6)
	topFront := s.ring(front, s.asset("font_top_front.png"), 32, 25, 32, s.data.Strings["text_top"], 6)
	topBack := s.ring(back, s.asset("font_top_back.png"), 32, 25, 32, s.data.Strings["text_top"], 6)
	sine := s.ring(sineText, s.asset("font_sin.png"), 32, 16, 32, s.data.Strings["text_sin"], 3)
	rFront := s.ring(dnaFront, s.asset("font_dna_front.png"), 32, 25, 32, s.data.Strings["text_dna"], 4)
	rBack := s.ring(dnaBack, s.asset("font_dna_back.png"), 32, 25, 32, s.data.Strings["text_dna"], 4)
